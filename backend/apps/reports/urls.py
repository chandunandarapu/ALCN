...
from .views import (
    ...
    ExportProjectsExcelAPIView,
    ExportTasksExcelAPIView,
    ExportClientsExcelAPIView,
)
...
urlpatterns = [
    ...
    path('export/projects/excel/', ExportProjectsExcelAPIView.as_view()),
    path('export/tasks/excel/', ExportTasksExcelAPIView.as_view()),
    path('export/clients/excel/', ExportClientsExcelAPIView.as_view()),
]